...
Com relação a redução de dimensionalidade, no estudo desenvolvido por \citeonline{guler2005classification}, realizou-se um processo de classificação utilizando SVM e sEMG e para a redução de dimensionalidade utilizou-se a combinação entre a FFT, combinada com a PCA. Esta combinação é utilizada para facilitar o cálculo e armazenamento dos dados do sinal sEMG. Por fim, em \citeonline{guler2005classification} foi concluido que o SVM possui uma alto nível de predição com relação aos sinais sEMG.
...
SVM também foi utilizada por \citeonline{kugler2013automated}, que combinou sEMG com sinais de um acelerômetro, para identificar a DP e o Tremor essencial, neste trabalho utilizou-se a validação cruzada, para verificar a integridade dos resultados.

Outro trabalho interessante foi realizado por \citeonline{loconsole2018model}, que propôs uma técnica em 3 estágios para diferenciar portadores da DP, foi utilizada uma análise caligráfica com sEMG, para a classificação dos dados, foi utilizado um SVM alinhada com uma RNA.
