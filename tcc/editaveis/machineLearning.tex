...
A documentação oficial do \citeonline{scikit-learn} lista também as principais desvantagens relacionadas ao SVMs como não fornecem estimativas de probabilidade diretamente.

\begin{figure}[!htb]
    \centering
     \includegraphics[width=1\textwidth]{figuras/svmkernel.eps}
     \caption{Exemplos de SVMs utilizando \textit{kernel} diferentes, adaptado de \citeonline{scikit-learn}}
     \label{svmkernel}
 \end{figure}