...
\begin{figure}[!htb]
 ...
 As SVMs foram desenvolvidas no âmbito da Teoria Estatística da Aprendizagem, logo para entender o funcionamento do dado modelo é necessário entender o próprio framework da Teoria Estatística da Aprendizagem [CITE].
