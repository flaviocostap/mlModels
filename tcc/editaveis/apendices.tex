\begin{anexosenv}
   ...
   Foi adotado devido a seu leve consumo de dados, além de possuir uma fácil implementação.
    ...
    A arquitetura se baseia em dois modelos arquiteturais, REST e SPA, interligados com um modelo de aprendizado de máquinas. No caso a Floresta Aleatória ou o SVM, como observado na figura A Figura \ref{diagramadepacotes}. Deste modo a aplicação possui três pacotes:
   ...
   \end{figure}
    ...
    A tabela \ref{table:Instrucao do Problema} descreve brevemente a oportunidade de negócios que é tratada por este projeto segundo o problema no qual o mesmo se dedica a solucionar em uma instrução geral resumida no nível mais alto.
