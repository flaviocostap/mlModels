\begin{anexosenv}
	...
	A \ref{table:Instrucao do Problema} descreve brevemente a oportunidade de negócios que é tratada por este projeto segundo o problema no qual o mesmo se dedica a solucionar em uma instrução geral resumida no nível mais alto.
	...
	Para fornecer produtos e serviços que atendam às necessidades das partes interessadas e dos usuários, é necessário identificar e envolver todas as partes interessadas como parte do processo de definição dos requisitos. Essa seção se dedica a apresentar e detalhar os perfis dos interessados no projeto e usuários do sistema. 

	\subsection{Resumo da Parte Interessada}

	A \ref{table:Resumo da Parte Interessada} possui um breve resumo dos interessados no projeto, descrevendo-os e apresentando suas respectivas responsabilidades dentro do mesmo.
	...
	\begin{table}[ht]
		...
		\begin{tabular}{@{}|l|l|l|@{}}
			...
			\end{tabular} & \begin{tabular}{l}Desenvolvimento da solução \\ de software e pesquisa. 
			\end{tabular} \\ \hline
			\textbf{Orientadores} & \begin{tabular}{l}Professor orientador e\\ pesquisadores \end{tabular} & \begin{tabular}{l}Orientadores e avaliadores \\ que darão suporte a respeito \\ das  pesquisas e escrita do TCC \\ assim como no desenvolvimento \\ do sistema. \end{tabular} \\ \hline
		\end{tabular}
	...
	A \ref{table:Resumo do Usuário} apresenta um breve resumo do usuário do sistema com sua descrição e seu papel desempenhado na operação do mesmo.
	...
	A \ref{table:Perfil dos Orientandos} detalha o perfil dos orientados do projeto.
	...
	\begin{table}[ht!]
		...
		\begin{tabular}{@{}|l|l|@{}}
			...
			\textbf{Responsabilidades}    & \begin{tabular}{l}Desenvolvimento da solução de software e pesquisa \end{tabular} \\ \hline
			\textbf{Critérios de Sucesso} & \begin{tabular}{l}Manter os prazos estabelecidos sem atraso, e gerenciar \\ a qualidade do software em desenvolvimento \end{tabular} \\ \hline
	...
	A \ref{table:Perfil dos Orientadores} detalha o perfil dos orientadores do projeto.
	...
	\begin{table}[ht!]
		...
		\begin{tabular}{@{}|l|l|@{}}
			\hline
			\textbf{Representantes}       & \begin{tabular}{l}Dra. Lourdes Mattos Brasil, MSc. Roberto Aguiar Lima \end{tabular} \\ \hline
	...
	Essa seção descreve o usuário do sistema e assim como os perfis das partes interessadas apresentadas nas tabelas \ref{table:Perfil dos Orientandos} e \ref{table:Perfil dos Orientadores} também descreve de maneira mais detalhada demonstrando seu grau de envolvimento no projeto, critérios para sucesso do mesmo e suas responsabilidades dentro do projeto. 

	\subsubsection{Médicos}

	A \ref{table:Perfil dos Médicos} descreve o perfil do médico, usuário principal do sistema.
	...
	A \ref{table:Resumo dos recursos} Apresenta os principais recursos do sistema. 
