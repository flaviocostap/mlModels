\begin{anexosenv}
	...
	% 	\begin{tabular}{|c|c|}
	% 		\hline
	% 		\textbf{O problema}            & \begin{tabular}{c} Baixa eficiência do \\ diagnóstico da doença de Parkinson                   \end{tabular}       \\ \hline
	% 		\textbf{Afeta}                 & \begin{tabular}{c} Os pacientes                                                              \end{tabular}       \\ \hline
	% 		\textbf{Cujo o impacto é}      & \begin{tabular}{c} Um possível diagnóstico \\ tardio da doença                                  \end{tabular}       \\ \hline
	% 		\textbf{Uma boa solução seria} & \begin{tabular}{c} Sistema automatizado capaz fornecer um diagnóstico \\ prévio da doença de Parkinson \end{tabular}\\ \hline
	% 	\end{tabular}
	...
	% 		\textbf{Orientandos}          & \begin{tabular}{c} Estudantes matriculados na \\disciplina  de TCC 2 \end{tabular}  		  & \begin{tabular}{c} Desenvolvimento da solução  \\de software e pesquisa \end{tabular}	\hline
	% 		\textbf{Orientadores}         & \begin{tabular}{c} \textit{Project Owner} e pesquisador voluntário \end{tabular}      & \begin{tabular}{c} Orientadores e avaliadores \\que darão suporte a respeito das pesquisas e escrita \\do TCC assim como no desenvolvimento  do sistema. \end{tabular}
	% 		\hline
	% 		\end{tabular}}
